...
export default function DeployContainer() {
  ...
  return (
    <div className="flex items-center h-max w-full py-20 px-4 flex-col gap-4 md:px-6">
      <div className=" w-full max-w-lg bg-gray-900 shadow-2xl flex flex-col items-center gap-8 text-center rounded-lg border border-gray-200 p-6 dark:border-gray-800 relative">
        <h1 className="text-3xl font-bold">Deploy your project</h1>
        <p className="text-gray-500 dark:text-gray-400 ">
          Import code from GitHub <br /> And Make sure this repository is public
        </p>
        <div className="flex flex-col w-full gap-2 relative">
          ...
          <div className="absolute top-5 transform -translate-y-1/2 right-3">
            ...
            {fetching && <Loader size={24} strokeWidth={2} color="#374151" />}
            {validRepo && !fetching && (
